...
/***/ function(module, exports, __webpack_require__) {
	...
	var initModule = function initModule() {
	    ...
	    ReactDOM.render(React.createElement(Text, null), document.getElementById('spa'));
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	core.log = log = function log(msg) {
	    console.log(msg);
	};

	// 用id选择Dom元素,快
	core.$ = function (el) {
	    var result = document.getElementById(el) || sizzle();
	    return result;
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(8);
	var ReactDOM = __webpack_require__(40);
	var hammer = __webpack_require__(176);
	...
	var Text = React.createClass({
	    ...
	    render: function render() {
	        return React.createElement(
	            'div',
	            { className: 'container', id: 'tt' },
	            React.createElement(
	                'div',
	                { className: 'lead-body' },
	                React.createElement('div', { className: 'lead-body-logo animated fadeInDown' }),
	                React.createElement('div', { className: 'lead-body-title' }),
	                React.createElement(
	                    'div',
	                ...
	                React.createElement(
	                    'div',
	                    { className: 'lead-body-sign' },
	                    React.createElement(
	                        'button',
	                        { id: 'signIn', className: 'lead-body-sign-btn mt-02r animated fadeIn' },
	                        React.createElement(
	                            'span',
	                            null,
	                            '登录'
	                    ...
	                    React.createElement(
	                        'button',
	                        { id: 'signUp', className: 'lead-body-sign-btn mt-05r animated fadeIn' },
	                        React.createElement(
	                            'span',
	                            null,
	                            '注册'
