	    ...
	    render: function render() {
	        return React.createElement(
	            ...
	            React.createElement(
	                ...
	                React.createElement(
	                    'div',
	                    { className: 'col avatar-image-wrap' },
	                    React.createElement('img', { src: '/img/userprofile.png' })
	                ),
	                React.createElement(
	                    'div',
	            ...
	            React.createElement(
	                'div',
	                { className: 'row avatar-text' },
	                React.createElement(
	                    'h3',
	                    { className: 'avatar-title-big text-center' },
	                    '大师设计'
	                ),
	                React.createElement(
	                    'h4',
	                    { className: 'avatar-title-small text-center' },
	                    'www.masterdesign.com'
	                )
	            )
	        );
	    }
	...
	var show = React.createClass({
	    ...
	    render: function render() {
	        return React.createElement(
	            ...
	            React.createElement(
	                'div',
	                { className: 'col show-group' },
	                React.createElement(
	                    'div',
	                    { className: 'show-image-wrap' },
	                    React.createElement('img', { src: '/img/media1.jpg' })
	                )
	            ),
	            React.createElement(
	                'div',
	                ...
	                React.createElement(
	                    'div',
	                    { className: 'show-image-wrap' },
	                    React.createElement('img', { src: '/img/media3.png' })
	                )
	            ),
	            React.createElement(
	                'div',
	                ...
	                React.createElement(
	                    'div',
	                    { className: 'show-image-wrap' },
	                    React.createElement('img', { src: '/img/media4.png' })
	                )
	            ),
	            React.createElement(
	                'div',
	                ...
	                React.createElement(
	                    'div',
	                    { className: 'show-image-wrap' },
	                    React.createElement('img', { src: '/img/media7.png' })
	                )
	            )
	        );
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	ReactDOM.render(React.createElement(Avatar, null), document.getElementById('R-avatar'));
